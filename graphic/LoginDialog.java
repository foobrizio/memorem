...
public class LoginDialog extends JDialog implements ActionListener {
	 ...
	 * Create the dialog.
	 */
	public LoginDialog(boolean registrazione,boolean autologin){
		...
		gbc_lblIlNicknameDeve.gridwidth = 3;
		...
		gbc_lblAlmenoCaratteri.gridwidth = 3;
	...
	public static void main(String[] args) {
		try {
			LoginDialog dialog = new LoginDialog(false,false);
